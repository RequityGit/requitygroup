...
// Static fallback — updated periodically, better than showing nothing
const FALLBACK_RATES = {
  treasury5yr: { value: 4.01, date: '2025-02-26' },
  treasury10yr: { value: 4.29, date: '2025-02-26' },
  sofr30day: { value: 4.34, date: '2025-02-26' },
  prime: { value: 7.50, date: '2025-02-26' },
};
...
export async function getLoanIndexes() {
  ...
  return lastGoodResult || FALLBACK_RATES;
}
